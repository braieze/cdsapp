...
// Definimos las estructuras base como constantes para evitar errores de .map()
const CULTO_STRUCTURE = [
  {
...
export const EVENT_TYPES = {
  ...
  ayuno: { 
    ...
    dot: 'bg-rose-500',
    structure: [],
    isMultiDay: true // Flag para lógica de rangos
  },
