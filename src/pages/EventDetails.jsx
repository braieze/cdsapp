...
export default function EventDetails() {
  ...
  // ✅ LLAVES CORREGIDAS PARA COINCIDIR CON LA BASE DE DATOS Y MYSERVICES
  const getStructure = () => {
    if (event.type === 'limpieza' || event.type === 'mantenimiento') {
      return [{ section: 'SECTORES Y TRABAJO', roles: [
        ...
        { key: 'baños', label: 'Baños y Pasillos', icon: Eraser, type: 'multi' },
    ...
    return [
      ...
      { section: 'OPERATIVO / UJERES', roles: [
        { key: 'puerta', label: 'Puerta / Bienvenida', icon: Users, type: 'multi' },
        { key: 'portero', label: 'Portería (cerrar)', icon: Lock, type: 'single' },
        { key: 'pasillo', label: 'Pasillo / Pasillos', icon: ArrowRight, type: 'multi' },
        { key: 'seguridad_autos', label: 'Seguridad Autos', icon: Car, type: 'multi' },
        { key: 'control_baños', label: 'Control de Baños', icon: Eraser, type: 'multi' },
